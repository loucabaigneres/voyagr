  ...
  return (
    <div className="min-h-screen bg-[#12121e] text-white">
      ...
      <div className="mx-auto max-w-2xl px-4 py-6">
        ...
        {!isGenerated && (
          <div className="mb-6">
            <button
              ...
              className="w-full rounded-2xl bg-gradient-to-r from-[#6c63ff] to-[#a78bfa] px-6 py-4 text-sm font-bold text-white shadow-lg transition hover:brightness-110 disabled:opacity-60"
            >
            ...
            <div className="mb-4 flex justify-end">
              ...
              >
                {({ loading }) => (
                  <button
                    disabled={loading}
                    className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/[.04] px-4 py-2 text-xs font-semibold text-[#9a9ac0] transition hover:bg-white/[.08] hover:text-white disabled:opacity-50"
                  >
        ...
        {generateMutation.isPending && (
          <div className="mt-4 rounded-2xl border border-white/10 bg-white/[.03] p-6 text-center">
...
function ActivityRow({ activity, index }: { activity: Activity; index: number }) {
  ...
  return (
    <div className="flex gap-3 px-4 py-3.5">
      <div className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[rgba(108,99,255,.15)] text-[0.65rem] font-bold text-[#a9a2ff]">
        {index + 1}
      </div>
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-start justify-between gap-2">
          ...
          <span
            className="flex-shrink-0 rounded-full px-2 py-0.5 text-[0.6rem] font-semibold uppercase tracking-wide text-white/70"
            style={{ background: meta.color }}
          >
            {meta.label}
          </span>
