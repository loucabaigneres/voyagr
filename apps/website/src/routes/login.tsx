...
function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-[calc(100dvh-4rem)] items-center justify-center bg-[#0f0f13] px-4">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10"
        style={{
          background:
            'radial-gradient(50rem 40rem at 20% 0%, rgba(108,99,255,.15), transparent 60%), radial-gradient(40rem 30rem at 80% 100%, rgba(167,139,250,.10), transparent 55%)',
        }}
      />
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-[#9a9ac0]">Connecte-toi pour retrouver tes voyages</p>
        </div>

        {/* Card */}
        <div className="rounded-2xl border border-white/8 bg-white/4 p-8 backdrop-blur-sm">
          <h2 className="mb-6 text-lg font-bold text-[#e8e8f0]">Connexion</h2>
        ...
        <p className="mt-5 text-center text-sm text-[#9a9ac0]">
          ...
          <Link to="/register" className="font-semibold text-[#a9a2ff] hover:text-[#6c63ff]">
            S'inscrire
          </Link>
        </p>
      </div>
